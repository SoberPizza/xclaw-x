...
| 平台 | GPU | 键鼠 | 全链路延迟 |
|------|-----|------|-----------|
| Windows + NVIDIA GPU | CUDA 12.x（torch cu121 + PaddlePaddle cu126） | ctypes SendInput | ~1-1.5s |
...
- **paddle-cu126** — Windows 的 PaddlePaddle GPU CUDA 12.6 wheels（PyPI 上的 `paddlepaddle-gpu` 最高仅 2.6.2，在 Python 3.12 下有兼容性问题）
